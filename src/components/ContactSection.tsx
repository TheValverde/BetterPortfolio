            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  I'm always interested in discussing new opportunities, AI projects, or just having a chat about technology and innovation.
                </p>
              </div>
              ...
              <div className="bg-background/50 p-6 rounded-lg border border-border">
                ...
                <a
                  href={`mailto:${process.env.NEXT_PUBLIC_SMTP_FROM}`}
